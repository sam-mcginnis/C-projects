...
{
	// The head of a linked list that holds the digits of an integer, stored in reverse order.
	Node *head;

	// Number of digits in the integer (which is equal to the number of nodes in the list).
	int length;
} ListyInt;
